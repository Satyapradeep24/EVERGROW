...
<head>
    ...
    <title>Advisor Dashboard | Invest Mart</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Assets Under Management</div>
                                    <div class="stat-digit"><i class="fa fa-usd"></i>2,500,000</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Recent Transactions</div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Overall Performance</div>
                                    <div class="stat-digit">12% Gain</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Portfolio Performance Overview</h4>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <ul class="widget-line-list m-b-15">
                                    <li class="border-right">90% <br><span class="text-success"><i class="ti-hand-point-up"></i> Positive</span></li>
                                    <li>10% <br><span class="text-danger"><i class="ti-hand-point-down"></i> Negative</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
